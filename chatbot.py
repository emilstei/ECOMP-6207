...
#chatbot introduction - Wonder Woman 1970s reference
print('Hello. I am the IRAC computer. I am a chatbot')
...
print('Interesting. I wonder if that food is good for your health.')
