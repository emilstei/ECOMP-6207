...
#set up level display using the label widget
level = 1
...
def move_candy():
    ...
    #schedule this function to move again
...
#function called to end of game - derstroys window
def end_game_over():
    window.destroy()
...
window.after(1000, end_title) #destroys title and instructions
